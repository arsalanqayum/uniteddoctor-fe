<template>
  <div class="">
    ...
    display: flex;background:url('header-bg.jpg');min-height:500px;">
        ...
        <v-row>
          ...
          <v-col cols="12" xl="12" lg="12">
            <div class="align-center  d-flex mt-5 justify-center" id="home-banner-section">
                <h1 class="mb-3 title mb-md-5">Find and book the <span class="od-text-warning">best doctors</span> near you</h1>
            </div>
            <div class="align-center w-47 h-100 justify-center">
              ...
              <v-carousel-item v-for="(n, index) in heroSlider" :key="index">
                <v-sheet height="100%" light>
                  <v-row class="fill-height" align="center">
                    ...
                    <v-col cols="5" lg="4">
                      <v-img aspect-ratio="1" contain :src="n.img"></v-img>
                    </v-col>
                  </v-row>
                </v-sheet>
              </v-carousel-item>
          ...
          <div class="d-flex justify-space-between mb-4">
            <div class="d-flex align-center">
              <v-avatar size="24" tile>
                <img class="icon mr-2 primary--text" src="@/assets/images/icons/light.svg" alt=""/>
              </v-avatar>
      ...
      <div>
        ...
        >
          <div class="m-5" v-for="(n, index) in topCategories" :key="index">
            <v-col cols="12" class="">
              <nuxt-link to="/shop/SingleProduct">
                <base-card class="">
                  <v-card-text
      ...
      <div class="row">
        ...
        <v-col cols="12" sm="6" md="8" lg="8">
          <a href="#">
            <v-img
              cover
              :src="require('~/assets/images/banners/banner-2.png')"
            ></v-img>
          </a>
        </v-col>
      </div>
    ...
    <!-- <v-container class="mb-60">
      <v-row>
        <v-col cols="12">
          <div class="d-flex justify-space-between mb-5">
            <h2 class="font-weight-bold">More For You</h2>
            <a href="#" class="text-decoration-none blue-grey--text darken-1">
              View all
              <v-icon class="m-0 p-0">mdi-menu-right</v-icon>
            </a>
          ...
          <v-row>
            <v-col
              ...
              lg="3"
              xl="2"
              v-for="(item, index) in getProducts.slice(48, 60).map((n) => n)"
              :key="index"
            >
              <CardCart
                cardHoverShadow
    ...
    <v-container class="mb-60">
      <v-row>
        <v-col cols="12" sm="6" md="4" lg="3" xl="3">
          <base-card cardHoverShadow class="py-48">
            <v-card-text class="d-flex align-center justify-center flex-column">
              ...
              <v-card-subtitle
                ...
                >Delivering urgent medical attention and support for critical situations.</v-card-subtitle
              >
            </v-card-text>
          </base-card>
        </v-col>
        <v-col cols="12" sm="6" md="4" lg="3" xl="3">
          <base-card cardHoverShadow class="py-48">
            <v-card-text class="d-flex align-center justify-center flex-column">
              ...
              <v-card-subtitle
                class="text-center grey--text text--darken-2 pt-0"
                >Virtual consultations with healthcare professionals for personalized medical advice.</v-card-subtitle
              >
            </v-card-text>
          </base-card>
        </v-col>
        <v-col cols="12" sm="6" md="4" lg="3" xl="3">
          <base-card cardHoverShadow class="py-48">
            <v-card-text class="d-flex align-center justify-center flex-column">
              ...
              <v-card-subtitle
                class="text-center grey--text text--darken-2 pt-0"
                >Track and monitor vital signs and health metrics for proactive health management.</v-card-subtitle
              >
            </v-card-text>
          </base-card>
        </v-col>
        <v-col cols="12" sm="6" md="4" lg="3" xl="3">
          <base-card cardHoverShadow class="py-48">
            <v-card-text class="d-flex align-center justify-center flex-column">
              ...
              <v-card-subtitle
                class="text-center grey--text text--darken-2 pt-0"
                >Efficient medication management with reminders and dosage tracking.</v-card-subtitle
              >
            </v-card-text>
          </base-card>
        </v-col>
...
export default {
  ...
  data() {
    return {
      flash: require('@/assets/images/icons/light.svg'),
      slickSettings: {
        infinite: false,
        speed: 500,
        slidesToShow: 6,
