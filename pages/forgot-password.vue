            ...
            <base-card class="ma-auto w-33">
                <div class="px-3 px-md-10 py-8">
                    ...
                    <v-form ref="registration" @submit.prevent="save">
                        ...
                        <v-text-field  :rules="[(v) => !!v || 'First Name is required']" outlined dense hide-details placeholder="example@mail" v-model="form.email"
                            class="mb-4"></v-text-field>

                        <v-btn type="submit" block color="primary" class="text-capitalize font-600">Send Link</v-btn>
                    </v-form>
                    ...
                    <div class="text-14 text-center my-3">
                        Login
                        <router-link to="/login" class="grey--text text--darken-4 font-600">Sign Up</router-link>
                    </div>
                </div>
        ...
        save() {
            ...
            if (validate) {
                this.$axios.post(`password/email`, this.form).then((response) => {
                    ...
                    this.$toast.success('Reset password link sent to your inbox');
